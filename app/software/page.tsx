...
const Software = () => {
  ...
  const projects = [
    {
      ...
      demo: "https://github.com/noahnghg/LifeSync",
      featured: false
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: "/about/my-image.png", // Using existing local image as placeholder
      tech: ["Next.js", "Tailwind CSS", "Framer Motion", "Vercel"],
      github: "https://github.com/noahnghg-portfolio",
      demo: "https://noahnghg-portfolio.vercel.app"
    },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-600 via-slate-500 to-gray-500 relative overflow-hidden">
      ...
      {/* Projects Grid */}
      {showProjects && (
        <section className="px-4 sm:px-6 lg:px-8 pb-12 sm:pb-20 animate-fade-in-up relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              {projects.map((project) => (
                <div
                  key={project.id}
                  className={`card bg-slate-600/50 border border-sky-blue/30 shadow-lg hover:shadow-xl hover:border-sky-blue/50 transition-all duration-300 transform hover:-translate-y-2 group backdrop-blur-sm ${project.featured ? 'md:col-span-2 lg:col-span-1' : ''
                    }`}
                >
                  {/* Project Image */}
                  <figure className="relative overflow-hidden">
                    ...
                    <div className="absolute top-2 sm:top-4 left-2 sm:left-4 flex flex-col gap-1 sm:gap-2">
                      {project.featured && (
                        <span className="bg-sky-blue/20 border border-sky-blue/40 text-sky-blue px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium">Featured</span>
                      )}
                      {project.inProgress && (
                        <span className="bg-amber-500/20 border border-amber-500/40 text-amber-400 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium animate-pulse">
                          🚧 In Progress
                        </span>
                      )}
                    </div>
                  ...
                  <div className="card-body p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 gap-2">
                      ...
                      {project.inProgress && (
                        <div className="flex items-center gap-1 text-amber-400 text-sm">
                          ...
                          <span className="text-xs font-medium whitespace-nowrap">Active Development</span>
                        </div>
                      )}
                    </div>
                    ...
                    <p className="text-white/70 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
                      {project.description}
                      {project.inProgress && (
                        <span className="block mt-2 text-amber-400/80 text-xs sm:text-sm italic">
                    ...
                    <div className="card-actions flex-col sm:flex-row justify-between items-stretch sm:items-center gap-2">
                      <div className="flex gap-2 w-full sm:w-auto">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="btn btn-xs sm:btn-sm bg-gradient-to-r from-sky-blue to-soft-blue hover:from-soft-blue hover:to-sky-blue text-black border-none transition-all flex-1 sm:flex-none"
                        >
            ...
            <div className="text-center mt-8 sm:mt-16">
              <div className="card bg-slate-600/50 border border-sky-blue/30 backdrop-blur-sm">
                <div className="card-body text-center p-6 sm:p-8">
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-white to-soft-blue bg-clip-text text-transparent">Interested in working together?</h3>
                  <p className="text-white/70 mb-4 sm:mb-6 text-sm sm:text-base">
                    I&apos;m always open to discussing new opportunities and exciting projects.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                    <Link href="/about" className="btn rounded-full bg-gradient-to-r from-white to-soft-blue hover:from-soft-blue hover:to-sky-blue text-white border-none btn-sm sm:btn-md lg:btn-lg px-6 sm:px-8 shadow-lg hover:shadow-xl transition-all w-full sm:w-auto">
                      <span className="text-black text-sm sm:text-base">Get in touch</span>
                    </Link>
                    <a href="mailto:noahnghg@gmail.com" className="btn rounded-full bg-transparent border-2 border-sky-blue/70 text-sky-blue hover:bg-sky-blue/20 hover:border-sky-blue btn-sm sm:btn-md lg:btn-lg px-6 sm:px-8 transition-all w-full sm:w-auto text-sm sm:text-base">
                      Send Email
                    </a>
                  </div>
                </div>
